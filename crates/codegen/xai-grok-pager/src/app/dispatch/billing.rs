...
pub(crate) const FREE_USAGE_USER_MESSAGE: &str = "You\u{2019}ve reached the X provider's free coding-agent usage limit for now. Get SuperGrok for higher X provider limits, or try again later: https://grok.com/supergrok?referrer=grok-build";
...
pub(super) fn open_credit_limit_upsell(
    ...
    let (
        ...
        CreditLimitUpsellMode::UnifiedCredits => (
            ...
            "Buy more credits",
            "Purchase X provider credits to continue",
...
fn open_supergrok_upsell(
    ...
    let options = vec![
        ...
        QuestionOption {
            ...
            description: "Increase your X provider usage limits.".into(),
            preview: None,
